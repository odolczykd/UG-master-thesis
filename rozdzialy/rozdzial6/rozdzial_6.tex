...
\begin{enumerate}
    \item Wyniki benchmarku przeprowadzonego w trybie \texttt{Throughput} (testu przepustowości), przedstawione w tabelach \ref{table:benchmark-thrpt-q1}, \ref{table:benchmark-thrpt-q2} i \ref{table:benchmark-thrpt-q3}, podane są jako liczba operacji na sekundę. Wykresy przedstawione na rysunkach \ref{fig:benchmark-A-thrpt-Q1}, \ref{fig:benchmark-A-thrpt-Q2} i \ref{fig:benchmark-A-thrpt-Q3} prezentują te dane na osi pionowej w jednostce oznaczonej jako ops/s.
...
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q2_16.pdf}
%         \caption{poziom współbieżności: 16}
%         \label{fig:benchmark-A-thrpt-Q2-16}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q2_32.pdf}
%         \caption{poziom współbieżności: 32}
%         \label{fig:benchmark-A-thrpt-Q2-32}
%     \end{subfigure}
...
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q2_64.pdf}
%         \caption{poziom współbieżności: 64}
%         \label{fig:benchmark-A-thrpt-Q2-64}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q2_256.pdf}
%         \caption{poziom współbieżności: 256}
%         \label{fig:benchmark-A-thrpt-Q2-256}
%     \end{subfigure}
...
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q2_1024.pdf}
%         \caption{poziom współbieżności: 1024}
%         \label{fig:benchmark-A-thrpt-Q2-1024}
%     \end{subfigure}
%     \caption{Wykresy kolumnowe przepustowości dla różnych modeli współbieżności w scenariuszu A dla zapytania \texttt{Q2}}
%     \source{opracowanie własne}
%     \label{fig:benchmark-A-thrpt-Q2}
% \end{figure}
...
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q3_16.pdf}
%         \caption{poziom współbieżności: 16}
%         \label{fig:benchmark-A-thrpt-Q3-16}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q3_32.pdf}
%         \caption{poziom współbieżności: 32}
%         \label{fig:benchmark-A-thrpt-Q3-32}
%     \end{subfigure}
...
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q3_64.pdf}
%         \caption{poziom współbieżności: 64}
%         \label{fig:benchmark-A-thrpt-Q3-64}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.49\textwidth}
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q3_256.pdf}
%         \caption{poziom współbieżności: 256}
%         \label{fig:benchmark-A-thrpt-Q3-256}
%     \end{subfigure}
...
%         \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_thrpt_Q3_1024.pdf}
%         \caption{poziom współbieżności: 1024}
%         \label{fig:benchmark-A-thrpt-Q3-1024}
%     \end{subfigure}
%     \caption{Wykresy kolumnowe przepustowości dla różnych modeli współbieżności w scenariuszu A dla zapytania \texttt{Q3}}
%     \source{opracowanie własne}
%     \label{fig:benchmark-A-thrpt-Q3}
% \end{figure}
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_avg_Q1.pdf}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{poziom współbieżności: 1024}
        \label{fig:benchmark-A-avg-Q1-1024}
    \end{subfigure}
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=\textwidth]{rozdzialy/rozdzial6/wykresy/A_plot_avg_Q2.pdf}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{poziom współbieżności: 1024}
        \label{fig:benchmark-A-avg-Q2-1024}
    \end{subfigure}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{poziom współbieżności: 1024}
        \label{fig:benchmark-A-avg-Q3-1024}
    \end{subfigure}
