...
\newcommand{\thetitle}{Analiza porównawcza mechanizmów Project Loom z~modelami współbieżności w~środowisku JVM}
...
\pagestyle{empty}\begin{singlespace}\include{rozdzialy/tytulowa/tytulowa}\maketitle\end{singlespace}
...
\include{rozdzialy/wstep/wstep}
\cleardoublepage

\include{rozdzialy/rozdzial1/rozdzial_1}
\cleardoublepage

\include{rozdzialy/rozdzial2/rozdzial_2}
\cleardoublepage

\include{rozdzialy/rozdzial3/rozdzial_3}
\cleardoublepage

\include{rozdzialy/rozdzial4/rozdzial_4}
\cleardoublepage

\include{rozdzialy/rozdzial5/rozdzial_5}
\cleardoublepage

\include{rozdzialy/rozdzial6/rozdzial_6}
\cleardoublepage

\include{rozdzialy/rozdzial7/rozdzial_7}
\cleardoublepage

\include{rozdzialy/podsumowanie/podsumowanie}
\cleardoublepage
